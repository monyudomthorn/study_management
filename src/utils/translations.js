...
export const translations = {
  en: {
    ...
    addWeek: "Add Week",
    addWeekTooltip: "Add next week to semester",
    removeWeek: "Remove Week",
    removeWeekTooltip: "Remove this week",
    confirmDeleteWeekTitle: "Remove Academic Week",
    confirmDeleteWeekMessage: "Are you sure you want to remove this week? All attendance records in this week will also be deleted.",
    maxWeeksReached: "All 16 semester weeks have been added.",
    ...
    absentLimitTracker: "Absence Tracker",
    absentLimitTitle: "Absence Limit (19 Max)",
    absentDaysCount: "Days Absent",
    absentLimitSafeDesc: "left of 19 limit",
    absentLimitWarningDesc: "Warning: Approaching limit",
    absentLimitDangerDesc: "Critical: Limit reached (19/19)",
    absentWarningBannerText: "Attendance Warning: You have reached {count} absences (maximum limit is 19). Please be careful with your attendance.",
    absentDangerBannerText: "Attendance Alert: You have reached the maximum limit of 19 absences!",
  ...
  kh: {
    ...
    addWeek: "បន្ថែមសប្ដាហ៍",
    addWeekTooltip: "បន្ថែមសប្ដាហ៍បន្ទាប់នៃឆមាស",
    removeWeek: "លុបសប្ដាហ៍",
    removeWeekTooltip: "លុបសប្ដាហ៍នេះ",
    confirmDeleteWeekTitle: "បញ្ជាក់ការលុបសប្ដាហ៍សិក្សា",
    confirmDeleteWeekMessage: "តើអ្នកប្រាកដជាចង់លុបសប្ដាហ៍នេះមែនទេ? រាល់កំណត់ត្រាវត្តមាននៅក្នុងសប្ដាហ៍នេះក៏នឹងត្រូវលុបផងដែរ។",
    maxWeeksReached: "បានបន្ថែមគ្រប់ ១៦ សប្ដាហ៍នៃឆមាសហើយ។",
    ...
    absentLimitTracker: "ការតាមដានអវត្តមាន",
    absentLimitTitle: "កម្រិតអវត្តមាន (អតិបរមា ១៩)",
    absentDaysCount: "ថ្ងៃអវត្តមាន",
    absentLimitSafeDesc: "នៅសល់ នៃកម្រិតកំណត់ ១៩",
    absentLimitWarningDesc: "ការព្រមាន៖ ជិតដល់កម្រិតកំណត់",
    absentLimitDangerDesc: "គ្រោះថ្នាក់៖ បានដល់កម្រិតកំណត់ (១៩/១៩)",
    absentWarningBannerText: "ការព្រមានវត្តមាន៖ អ្នកបានឈប់អវត្តមានចំនួន {count} ថ្ងៃហើយ (កម្រិតអតិបរមាគឺ ១៩ ថ្ងៃ)។ សូមប្រុងប្រយ័ត្នវត្តមានរបស់អ្នក។",
    absentDangerBannerText: "ការជូនដំណឹងបន្ទាន់៖ បានឈានដល់ ឬលើសកម្រិតកំណត់អវត្តមានអតិបរមា ១៩ ថ្ងៃហើយ!",
